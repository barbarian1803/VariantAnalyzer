...
public class TranscriptFASTA {
    ...
    public TranscriptFASTA(String metadata) {
        ...
        this.sequence = "";
        this.geneID = this.parseGeneID(metadata);
        this.transcriptExons = new HashMap();
    }
    ...
    private String parseGeneID(String metadata) {
        String[] parsedMetadata = metadata.substring(1).split(" ");
        //3rd element: gene id
        String[] parsedData = parsedMetadata[3].split(":")[1].split("\\.");
        return parsedData[0];
    }
    ...
    public void printData() {
        System.out.println(this.geneID+" "+this.transcriptID);
    ...
    public String applyVariant(String sequence, String alleleRef, String variation, int exonID, int offset) throws IndexOutOfBoundsException{
